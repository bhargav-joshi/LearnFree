								...
								<div class="card-body">
									...
									<div class="leave-info-box">
										<div class="media align-items-center">
											<a href="profile.html" class="avatar"><img alt="" src="<?=base_url('assets/backend/');?>img/user.jpg"></a>
										...
										<table class="table custom-table mb-0">
											...
											<tbody>
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar"><img alt="" src="<?=base_url('assets/backend/');?>img/profiles/avatar-19.jpg"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="client-profile.html" class="avatar"><img alt="" src="<?=base_url('assets/backend/');?>img/profiles/avatar-07.jpg"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="client-profile.html" class="avatar"><img alt="" src="<?=base_url('assets/backend/');?>img/profiles/avatar-06.jpg"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="client-profile.html" class="avatar"><img alt="" src="<?=base_url('assets/backend/');?>img/profiles/avatar-14.jpg"></a>
...
<?php $this->load->view('User/inc/action');?>
